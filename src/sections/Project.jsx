...
const Project = () => {
  return (
    <section className='bg-gray-950 p-5 lg:px-18 xl:px-32' id='project'>
        ...
        whileInView={{scale:1, transition: {duration: 1, ease:'easeInOut'}}} 
          ...
          viewport={{once:true}} >
            ...
            <a href="https://weatherappbyrj.netlify.app/" className='md:hidden flex justify-center mt-4' target='blank'>
            ...
            <motion.div className='w-full h-full backdrop-blur-sm absolute right-0 top-0 hidden md:grid place-items-center'
            initial={{opacity: 0}}
...
<a href="https://codex-rj-portfolio.netlify.app/" className='md:hidden flex justify-center mt-4' target='blank'>
                      <button className='bg-csGreen border-2 border-csGreen  text-black m-2 ml-0 px-4 py-2 text-sm sm:text-lg font-semibold transition-colors duration-300 ease-linear hover:text-csGreen hover:bg-black'
                      >View Project</button></a>
          ...
          <motion.div className='p-5 bg-gray-900 my-5 relative'  
           ...
           whileInView={{scale:1, transition: {duration: 1, ease:'easeInOut'}}} 
            ...
            <a href="https://teacher-dashboard-cjkx.onrender.com/" className='md:hidden flex justify-center mt-4' target='blank'>
                      <button className='bg-csGreen border-2 border-csGreen  text-black m-2 ml-0 px-4 py-2 text-sm sm:text-lg font-semibold transition-colors duration-300 ease-linear hover:text-csGreen hover:bg-black'
                      >View Project</button></a>
          ...
          <motion.div className='p-5 bg-gray-900 my-5 relative'  
           ...
           whileInView={{scale:1, transition: {duration: 1, ease:'easeInOut'}}} 
            ...
            <a href="https://mynotes-mern.onrender.com/" className='md:hidden flex justify-center mt-4' target='blank'>
                      <button className='bg-csGreen border-2 border-csGreen  text-black m-2 ml-0 px-4 py-2 text-sm sm:text-lg font-semibold transition-colors duration-300 ease-linear hover:text-csGreen hover:bg-black'
                      >View Project</button></a>
